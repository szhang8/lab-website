...
A key finding from our lab is that early metastatic colonization involves a metabolic transcriptome shift driven by epigenetic upregulation of glutamate decarboxylase 1 (GAD1), which facilitates colonization through the GABA metabolic pathway. Repurposing the FDA-approved anti-seizure drug vigabatrin to inhibit this axis significantly reduced metastatic burden in vivo (Schnepp et al., *Cancer Research* 2017). To complement targeted mechanistic studies, we developed a hybrid screening strategy combining RNA profiling of temporal transcriptome changes with a rapid forward genetic screen in *Drosophila* to identify drivers of metastatic adaptation in an unbiased manner (*Nature Communications* 2020).
